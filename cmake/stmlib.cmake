function(stmlib_create_project)
    ...
    add_custom_target(burn-${PROJECT_NAME}
                    ...
                    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/tools/qspi-loader
                    DEPENDS ${PROJECT_NAME}
                    COMMENT "Burning ${PROJECT_NAME}.bin at ${BURN_ADDR}"
                    USES_TERMINAL)
endfunction()

function(create_app_from_project)
    set(APP_PATH ${CMAKE_CURRENT_SOURCE_DIR}/projects/${PROJECT_NAME})
    file(GLOB APP_CSRC ${APP_PATH}/*.c)
    file(GLOB APP_CXXSRC ${APP_PATH}/*.cpp)
    file(GLOB APP_H ${APP_PATH}/*.h)
    add_executable(${PROJECT_NAME} ${APP_CXXSRC} ${APP_CSRC} ${APP_H})
    target_include_directories(${PROJECT_NAME} PUBLIC ${APP_PATH}/)
    stmlib_create_project()
endfunction()
